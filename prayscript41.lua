...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		...
		nextpage="prayscript42"
		prevpage="prayscript33"
		composer.gotoScene( nextpage, "slideLeft", 800  )
		else
		nextpage="prayscript33"
		prevpage="prayscript42"
...
function scene:show( event )
	...
	text2 = display.newText( a[4][4], 0, 0, display.contentWidth*ratiow,display.contentHeight*ratiow,native.systemFont, fontsize)
