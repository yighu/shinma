...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		...
		prevpage="prayscript23"
		composer.gotoScene( nextpage, "slideLeft", 800  )
		else
		nextpage="prayscript23"
...
function scene:show( event )
	...
	text2 = display.newText( a[3][4], 0, 0, display.contentWidth*ratiow,display.contentHeight*ratiow,native.systemFont, fontsize)
