...
function scene:show( event )
	...
	text2 = display.newText( a[4][3], 0, 0, display.contentWidth*ratiow,display.contentHeight*ratiow,native.systemFont, fontsize)
